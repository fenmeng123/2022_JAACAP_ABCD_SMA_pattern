function [Res,mdl,T_DV] = s_ParaLongitudinalLME(compact_data,Y_Name,ModelSpec)
...
mdl{i} = fitlme(T,...
    LME_Formula,...
    'FitMethod','REML','DummyVarCoding','effects','CovariancePattern',{'Diagonal','Diagonal'},'CheckHessian',true);
